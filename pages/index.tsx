...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="font-sans bg-gradient-to-b from-blue-100 to-blue-200 text-gray-800 min-h-screen flex justify-center items-center p-5">
      <div className="text-center">
        {/* Main Heading */}
        <h1 className="text-6xl font-bold text-blue-900 mb-2 font-serif">
          Scriptorium
        </h1>
        <h2 className="text-xl text-blue-700 italic mb-5">
          Welcome to Scriptorium: a new way to share, learn, and execute code
        </h2>
        ...
        <div className="flex flex-wrap justify-center gap-5 mt-8">
          <button
            className="px-8 py-4 bg-blue-600 text-white rounded-lg text-lg transition-transform transform hover:bg-blue-800 hover:scale-105"
            onClick={() => router.push("/blogs")}
          >
            Read or create a blog
          </button>
