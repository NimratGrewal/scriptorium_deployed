...
# chmod +x ./dockerfiles/build-all.sh
# sh ./dockerfiles/build-all.sh


docker build -f "./dockerfiles/Dockerfile.c" -t "c-runner" .
docker build -f "./dockerfiles/Dockerfile.cpp" -t "cpp-runner" .
docker build -f "./dockerfiles/Dockerfile.python" -t "python-runner" .
docker build -f "./dockerfiles/Dockerfile.java" -t "java-runner" .
docker build -f "./dockerfiles/Dockerfile.javascript" -t "node" .
docker build -f "./dockerfiles/Dockerfile.r" -t "r-runner" .
docker build -f "./dockerfiles/Dockerfile.go" -t "go-runner" .
docker build -f "./dockerfiles/Dockerfile.php" -t "php-runner" .
docker build -f "./dockerfiles/Dockerfile.ruby" -t "ruby-runner" .
docker build -f "./dockerfiles/Dockerfile.perl" -t "perl-runner" .
